...
export const HANDLE_TABLE_NUMBER_OF_ROWS_SELECT = 'HANDLE_TABLE_NUMBER_OF_ROWS_SELECT';  
...
/**
 * Update display table rows value
 */
 export const updateTableRowsValue = (value) => {
    return{
      type: HANDLE_TABLE_NUMBER_OF_ROWS_SELECT,
      payload:value
    }
 }
